...
#import "JDLLoadingView.h"

@interface JDLLoadingView()
{
...
{
    //圆
    _container = [[UIView alloc] initWithFrame:CGRectMake(0, 0, KAdaptX(50),KAdaptX(50))];
    ...
    _imageView2.backgroundColor = kThemeColor;
...
+(void)showInView:(UIView *)view{
    ...
    JDLLoadingView *loading = [[JDLLoadingView alloc] initWithFrame:view.bounds];
    [loading show];
...
+(void)dismissInView:(UIView *)view{
    ...
    for (JDLLoadingView *loading in view.subviews) {
        if ([loading isKindOfClass:[JDLLoadingView class]]) {
